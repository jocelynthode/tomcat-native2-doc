...
\subsection{Dynamic Loading}
Some experiments regarding dynamic loading were performed in a separate branch on our \mytitle{} repository. This would enable \mytitle{} to not only use OpenSSL but other TLS/SSL libraries such as LibreSSL or BoringSSL. We unfortunately could not find the time to finish this work as this proved to be more complicated than we anticipated.
